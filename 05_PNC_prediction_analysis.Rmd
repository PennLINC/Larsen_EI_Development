...
```{r 400, warning=FALSE}
pred_results <- data_mgmt('/cbica/projects/alpraz_EI/output/PNC_predictions/schaefer400x7_aal_all_FD5.rds')
...
```{r transmodal}
pred_results <- data_mgmt('/cbica/projects/alpraz_EI/output/PNC_predictions/schaefer400x7_aal_transmodal25_FD5.rds')
alpraz_results <- readRDS("/cbica/projects/alpraz_EI/output/drug_classification/schaefer400x7_aal_GSR_transmodal25_svm_1_permute_on_FD5results.rds")
...
```{r unimodal}
pred_results <- data_mgmt('/cbica/projects/alpraz_EI/output/PNC_predictions/schaefer400x7_aal_unimodal25_FD5.rds')
alpraz_results <- readRDS("/cbica/projects/alpraz_EI/output/drug_classification/schaefer400x7_aal_GSR_unimodal25_svm_1_permute_on_FD5results.rds")
...
```{r s200, eval = FALSE}
pred_results <- data_mgmt('/cbica/projects/alpraz_EI/output/PNC_predictions/schaefer200x7_aal_all_FD5.rds')
...
```{r aal,eval=FALSE}
pred_results <- data_mgmt('/cbica/projects/alpraz_EI/output/PNC_predictions/aal116_all_FD5.rds')
...
pred_results <- data_mgmt('/cbica/projects/alpraz_EI/output/PNC_predictions/glasser360_aal_all_FD5.rds')
...
### Gordon
```{r Gordon,eval=FALSE}
pred_results <- data_mgmt('/cbica/projects/alpraz_EI/output/PNC_predictions/gordon333_aal_all_FD5.rds')
