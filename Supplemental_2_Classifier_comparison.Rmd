...
Analyses for Table S3 and Figure S2.  
...
schaef200_results <- data_mgmt('output//PNC_predictions/schaefer200x7_aal_all.rds')
...
schaef200 <- readRDS(sprintf("output//drug_classification/%s_GSR_all_svm_1_permute_on_results.rds",
                                   atlasname))
...
schaef400_results <- data_mgmt('output//PNC_predictions/schaefer400x7_aal_all.rds')
schaef400_smooth <- get_smooths(schaef400_results)
schaef400_smooth$parcellation = "schaef400"

schaef400 <- readRDS(sprintf("output//drug_classification/%s_GSR_all_svm_1_permute_on_results.rds",
                                   atlasname))
...
```{r aal,eval=TRUE}
atlasname= "aal116"
aal_results <- data_mgmt('output//PNC_predictions/aal116_all.rds')
aal_smooth <- get_smooths(aal_results)
aal_smooth$parcellation = "aal"

aal <- readRDS(sprintf("output//drug_classification/%s_GSR_all_svm_1_permute_on_results.rds",
                                   atlasname))
aal <- aal[[1]]
```
...
glasser_results <- data_mgmt('output//PNC_predictions/glasser360_aal_all.rds')
glasser_smooth <- get_smooths(glasser_results)
glasser_smooth$parcellation = "glasser"

glasser <- readRDS(sprintf("output//drug_classification/%s_GSR_all_svm_1_permute_on_results.rds",
                                   atlasname))
glasser <- glasser[[1]]
```
...
gordon_results <- data_mgmt('output//PNC_predictions/gordon333_aal_all.rds')
...
gordon <- readRDS(sprintf("output//drug_classification/%s_GSR_all_svm_1_permute_on_results.rds",
                                   atlasname))
gordon <- gordon[[1]]
```
